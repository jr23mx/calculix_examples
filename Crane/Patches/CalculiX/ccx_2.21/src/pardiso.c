...
/* Added by Victor Kemp 2024-01-09 to enable Out-Of-Core (OOC) mode. */
void initialize_iparm(ITG *symmetryflag){
  ...
  if(env) {
    // PARDISO chooses IC/OOC mode according to the environment variables
    // MKL_PARDISO_OOC_MAX_CORE_SIZE and MKL_PARDISO_OOC_MAX_SWAP_SIZE.
    iparm[59]=1;
  }else{
